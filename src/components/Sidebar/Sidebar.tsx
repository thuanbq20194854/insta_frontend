...
export default function Sidebar() {
  ...
  return (
    <Container>
      ...
      <NavLink to='/' style={{ textDecoration: 'none', color: 'inherit' }} onClick={() => setActiveLink('/')}>
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              <div className='icon-container'>
                {activeLink === '/' ? (
                  <svg aria-label='Home' color='rgb(0, 0, 0)' fill='rgb(0, 0, 0)' role='img' viewBox='0 0 24 24'>
              ...
              <div className={activeLink === '/' ? 'link-title active' : 'link-title'}>Home</div>
            </div>
          )
        }}
      </NavLink>
        ...
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              ...
              <div className={activeLink === '/search' ? 'link-title active' : 'link-title'}>Search</div>
            </div>
          )
        }}
      </NavLink>
        ...
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              ...
              <div className={activeLink === '/explore' ? 'link-title active' : 'link-title'}>Explore</div>
            </div>
          )
        }}
      </NavLink>
        ...
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              <div className='icon-container'>
                {activeLink === '/messages' ? (
                  <svg aria-label='Messenger' color='rgb(0, 0, 0)' fill='rgb(0, 0, 0)' role='img' viewBox='0 0 24 24'>
              ...
              <div className={activeLink === '/messages' ? 'link-title active' : 'link-title'}>Messages</div>
            </div>
          )
        }}
      </NavLink>
        ...
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              ...
              <div className={activeLink === '/notifications' ? 'link-title active' : 'link-title'}>Notifications</div>
            </div>
          )
        }}
      </NavLink>
      ...
      {/* <div className='link-container'>
        <div className='icon-container'>
          <svg aria-label='Notifications' color='rgb(0, 0, 0)' fill='rgb(0, 0, 0)' role='img' viewBox='0 0 24 24'>
            <path d='M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z' />
          </svg>

          <svg aria-label='Notifications' color='rgb(0, 0, 0)' fill='rgb(0, 0, 0)' role='img' viewBox='0 0 48 48'>
            <path d='M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z' />
          </svg>
        </div>
        ...
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              <div className='icon-container'>
                {activeLink === '/create' ? (
                  <svg aria-label='New post' color='rgb(0, 0, 0)' fill='rgb(0, 0, 0)' role='img' viewBox='0 0 24 24'>
              ...
              <div className={activeLink === '/create' ? 'link-title active' : 'link-title'}>Creates</div>
            </div>
          )
        }}
      </NavLink>
      ...
      <NavLink
        to='/personalAccount'
        style={{ textDecoration: 'none', color: 'inherit' }}
        onClick={() => setActiveLink('/personalAccount')}
      >
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              <div className='avatar-container'>
                <img
                  ...
                  src='https://scontent.fhan17-1.fna.fbcdn.net/v/t39.30808-1/315993553_1529033717508630_326410295212552925_n.jpg?stp=cp0_dst-jpg_p86x86&_nc_cat=100&cb=99be929b-59f725be&ccb=1-7&_nc_sid=dbb9e7&_nc_ohc=A1vU8LObq4kAX_mFEuP&_nc_ht=scontent.fhan17-1.fna&oh=00_AfCLl2vJxJasbNRvFwyrdt4KGyKK3qxNw39G-O7z1vMXeQ&oe=648F29AB'
                  alt='personal-avatar'
                />
              </div>

              <div className={activeLink === '/personalAccount' ? 'link-title active' : 'link-title'}>Profiles</div>
            </div>
          )
        }}
      </NavLink>
      {/* <div className='link-container'>
        <div className='avatar-container'>
          <img
            className='avatar-image'
            src='https://instagram.fhan17-1.fna.fbcdn.net/v/t51.2885-19/316867824_960625712007611_5070261693186539030_n.jpg?stp=dst-jpg_s320x320&_nc_ht=instagram.fhan17-1.fna.fbcdn.net&_nc_cat=111&_nc_ohc=TkTdZM_DmpEAX_CYOMd&edm=AOQ1c0wBAAAA&ccb=7-5&oh=00_AfB908yNvvPexGVbuNyF_2bU85fPiYIgjKJVgoi2bj96lQ&oe=648E9E62&_nc_sid=f70a57'
            alt='personal-avatar'
          />
        </div>
        ...
        {({ isActive }: { isActive: boolean }) => {
          return (
            <div className='link-container'>
              <div className='icon-container'>
                {activeLink === '/more' ? (
                  <svg aria-label='Settings' color='rgb(0, 0, 0)' fill='rgb(0, 0, 0)' role='img' viewBox='0 0 24 24'>
              ...
              <div className={activeLink === '/more' ? 'link-title active' : 'link-title'}>More</div>
            </div>
          )
        }}
      </NavLink>
...
const Container = styled.div`
  ...
  /* min-height: 746px; // window.innerHeight */

  height: 100vh;
  padding: 8px 12px;
  border-right: 1px solid #c7c5ca;
  ...
  .link-container {
    ...
    .icon-container {
      ...
      transition: transform 0.75 ease;
    }
